...
阅读2.0版本的备份存在`Backup`文件夹中，阅读3.0版本的备份存在`legadoBackUp`文件夹中，其中的每个文件夹都是以“xxxx年-xx月xx日-xx时xx分”的规则命名。仅分享 **部分配置**。目前只更新3.0版本 。本项目主要通过[Github](https://github.com/ifwlzs/YueDuBackup)更新，[Gitee](https://gitee.com/ifwlzs/YueDuBackup)不定期更新。
